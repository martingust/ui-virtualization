System.register(['aurelia-templating-resources/array-repeat-strategy', 'aurelia-templating-resources/repeat-utilities'], function (_export) {
  ...
  var ArrayRepeatStrategy, createFullOverrideContext, updateOverrideContexts, updateOverrideContext, refreshBinding, ArrayVirtualRepeatStrategy;
  ...
  return {
    setters: [function (_aureliaTemplatingResourcesArrayRepeatStrategy) {
      ...
      refreshBinding = _aureliaTemplatingResourcesRepeatUtilities.refreshBinding;
    }],
    execute: function () {
